...
namespace TestClient32Bit
{
    class Program
    {
        ...
        {
            Console.WriteLine("32-bit Test Client for .NET Core COM Wrapper");
            Console.WriteLine("=============================================");
            Console.WriteLine();

            // First, try the simple direct assembly test
            Console.WriteLine("Testing Direct Assembly Loading (32-bit):");
            Console.WriteLine("=========================================");
            SimpleTest.RunTest();
            ...
            Console.WriteLine("Testing COM Interop (32-bit):");
            Console.WriteLine("=============================");
            TestComInterop();
        ...
        static void TestComInterop()
        {
            try
            {
                ...
                string comHostPath = Path.Combine(currentDir, "HelloWorldLib32.comhost.dll");
                ...
                if (comType == null)
                {
                    ...
                    try
                    {
                        var assembly = Assembly.LoadFile(Path.Combine(currentDir, "HelloWorldLib32.dll"));
                ...
                TestMethod(comObject, "GetPlatformInfo");
