...
namespace TestClient32
{
    public class SimpleTest
    {
        ...
        {
            Console.WriteLine("Simple Direct Assembly Test");
            Console.WriteLine("==========================");
            Console.WriteLine();
            ...
            try
            {
                ...
                string assemblyPath = Path.Combine(currentDir, "HelloWorldLib.dll");
                
                Console.WriteLine($"Looking for assembly at: {assemblyPath}");
                
                if (!File.Exists(assemblyPath))
                {
                    Console.WriteLine("ERROR: HelloWorldLib.dll not found");
                    return;
                }

                Console.WriteLine("✓ Found HelloWorldLib.dll");
